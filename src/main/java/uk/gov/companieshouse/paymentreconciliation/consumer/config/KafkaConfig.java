...
import uk.gov.companieshouse.paymentreconciliation.consumer.kafka.InvalidMessageRouter;
import uk.gov.companieshouse.paymentreconciliation.consumer.kafka.MessageFlags;
import uk.gov.companieshouse.paymentreconciliation.consumer.serdes.PaymentProcessedDeserialiser;
import uk.gov.companieshouse.paymentreconciliation.consumer.serdes.PaymentProcessedSerializer;
    ...
    public ConsumerFactory<String, payment_processed> consumerFactory(
        ...
        return new DefaultKafkaConsumerFactory<>(
                Map.of(
                        ...
                        ErrorHandlingDeserializer.VALUE_DESERIALIZER_CLASS, PaymentProcessedDeserialiser.class,
                        ConsumerConfig.AUTO_OFFSET_RESET_CONFIG, "earliest",
                        ConsumerConfig.ENABLE_AUTO_COMMIT_CONFIG, "false"),
                new StringDeserializer(),
                new ErrorHandlingDeserializer<>(new PaymentProcessedDeserialiser()));
    }

    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, payment_processed> kafkaListenerContainerFactory(
        ...
        return new DefaultKafkaProducerFactory<>(
                ...
                new DelegatingByTypeSerializer(
                        Map.of(
                                ...
                                payment_processed.class, new PaymentProcessedSerializer())));
    }
