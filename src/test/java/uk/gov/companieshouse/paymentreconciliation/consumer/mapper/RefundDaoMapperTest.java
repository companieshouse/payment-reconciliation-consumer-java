...
class RefundDaoMapperTest {
    ...
    private void assertRefundDaoFields(RefundDao result, String paymentId, String refundId, String email,
    ...
    void mapFromRefund_mapsAllFieldsCorrectly_companyNumberPresent() {
        ...
        setupMocks(refundId, email, paymentMethod, companyNumber, reference, status, productType, amount, createdAt,
                refundedAt);

        RefundDao result = mapper.mapFromRefund(paymentId, paymentResponse, refund);
        assertRefundDaoFields(result, paymentId, refundId, email, paymentMethod, companyNumber, reference, status,
                "500", createdAt, refundedAt, 1234);
    }
    ...
    void mapFromRefund_nullProductType_returnsNullProductCode() {
        ...
        RefundDao result = mapper.mapFromRefund(paymentId, paymentResponse, refund);
        assertRefundDaoFields(result, paymentId, refundId, email, paymentMethod, companyNumber, reference, status, "1",
                createdAt, refundedAt, null);
    }
}